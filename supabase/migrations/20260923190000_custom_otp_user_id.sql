-- Link OTP to auth user for reliable email confirm after verify
ALTER TABLE public.custom_otps ADD COLUMN IF NOT EXISTS user_id UUID;
...
-- Keep old 3-arg signature working
